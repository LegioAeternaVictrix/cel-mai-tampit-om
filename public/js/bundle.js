...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(username, firstName, lastName, email, password, passwordConfirm) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "We have sent an email with a confirmation link to your email address. In order to complete the sign-up process, please click the confirmation link.");
          ...
          case 7:
            ...
            (0, _alerts.showAlert)("danger", "Error signing up! Please try again.");
...
var stripe = Stripe("pk_test_51IMdGlDJ7RFd9fmdKKgb5HUkqThlBd9hiTmnkHOkUa7ClKvP84fvisVGaKPW14l1XW4UuuYGtN4hDFVUrJGVybIn00jnfBo1pp");

var buyCourse = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(courseId) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/orders/checkout-session/".concat(courseId));
...
var buyBtn = document.getElementsByClassName("buy-course-btn");
...
if (signupForm) signupForm.addEventListener("submit", function (e) {
  ...
  (0, _signup.signup)(username, firstName, lastName, email, password, passwordConfirm);
});
